...
// Implementation of the IBlogApi interface methods
    ...
    // Implementation for saving and deleting data
    ...
    public async Task<Tag?> SaveTagAsync(Tag item)
    {
        ...
        await SaveAsync<Tag>(_tags, _settings.CategoriesFolder, $"{item.Id}.json", item);
        return item;
    }
